...
<head>
  ...
  <title>Individual Investor Membership | Billennium Divas</title>
...
<?php require "../include/header/plainheader.php"?>
  ...
  <div class="panel panel-primary m-5 text-center">
      <div class="panel-heading">
              <h3 class="panel-title"> Membership Registration Form (Individual Investor)</h3>
      </div>
  </div>
      <div class="panel-body">
      <form method="post" action="direct_member_individual.php" name="direct_member_individual" onsubmit="validateForm()">
              <div class="col-md-2">
              </div>
