                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="stname" placeholder="Startup Firm Name *" value="" required/>
                            </div>
                            <div class="form-group">
                                <input type="number" class="form-control" name="ffname" placeholder="Founder Name 1 *" value="" required/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control"  name="website"  placeholder="Website URL *" value="" required/>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="sfname" placeholder="Founder Name 2 *" value="" required/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                            <label class="form-control" placeholder="Choose Industry*" value="">Choose Industry</label>
                            
                                <select  name="type" required class="form-control-placeholder" for="contact-person">
                                            <option value=""></option>
                                            <option value="Advertising">Advertising</option>
                                            <option value="Agriculture">Agriculture</option>
                                            <option value="Analytics">Analytics</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text"  name="phone" class="form-control" placeholder="Contact No*" value=""/>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Investments Received till date*" value=""/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="country" required class="form-control-placeholder" class="form-control">
                                            <option value=""></option>
                                            <option label="Afghanisthan">Afghanisthan</option>
                                            <option value="Aland Islands">Aland Islands</option>
                                            <option value="Albania">Albania</option>
                                            <option value="Algeria">Algeria</option>
                                            <option value="American Samoa">American Samoa</option>
                            ...
                            <div class="form-group">
                                <input type="number" name="city" class="form-control" placeholder="City *" value=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
