            ...
            <div class="form-content">
                ...
                <form method="POST" name="register_inv" id="indi" action="register_inv.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <select class="form-control" placeholder="Investment Range">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input name="confpass" type="text" class="form-control" placeholder="Confirm Password">
                            </div>
                        </div>
                    </div>
                ...
                <form method="POST" name="register_inv" id="inst" action="register_inv.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input name="password_1" type="text" class="form-control" placeholder="Password">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <input name="password_2" type="text" class="form-control" placeholder="Confirm Password">
                            </div>
                        </div>
                    </div>
