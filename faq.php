    ...
    <div class="accordion md-accordion p-md-5 m-md-5" id="accordionEx" role="tablist" aria-multiselectable="true"> 
        ...
        <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree3">
                ...
                <h5 class="mb-0">
                    When do investors meet? <i class="fas fa-angle-down rotate-icon"></i>
                </h5>
                </a>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree5">
                ...
                <h5 class="mb-0">
                    Are there any guidelines for presentations and business plans? <i class="fas fa-angle-down rotate-icon"></i>
                </h5>
                </a>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree6">
                ...
                <h5 class="mb-0">
                    What is the valuation to expect for our company? <i class="fas fa-angle-down rotate-icon"></i>
                </h5>
                </a>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree10">
                ...
                <h5 class="mb-0">
                    What are the typical terms for investment? <i class="fas fa-angle-down rotate-icon"></i>
                </h5>
                </a>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree11">
                ...
                <h5 class="mb-0">
                    What are the processes involved in an investment? <i class="fas fa-angle-down rotate-icon"></i>
                </h5>
                </a>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-header" role="tab" id="headingThree14">
                ...
                <h5 class="mb-0">
                    Any other expectations from our company? <i class="fas fa-angle-down rotate-icon"></i>
                </h5>
                </a>
            </div>
