<?php
    ...
    if(isset($_POST['company_save'])){
        ...
        if($cname != "")
		{
			$q = "UPDATE inv_details set CName='$cname' where InvID='$id';";
			mysqli_query($db, $q);
		}
        if($cweb != "")
		{
			$q = "UPDATE inv_details set Website='$cweb' where InvID='$id';";
			mysqli_query($db, $q);
		}
        if($cphone != "")
		{
...
<html>
    <head>
        ...
        <title><?=$CName?>'s Account Settings | Billennium Divas</title>
        <meta charset="utf-8">
            ...
            <div class="row">
                <div class="col-sm-4"><!--left col-->
                    ...
                    <form method="post" action="account.php" enctype="multipart/form-data">
                        ...
                        <img src="../../<?=$Logo?>" class="avatar img-circle img-thumbnail img-responsive img-fluid img-profile rounded-circle mx-auto" alt="avatar">
                            ...
                            <form class="form" action="account.php" method="post" id="contactForm" name="contactForm">
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="company_name" id="company_name" placeholder="<?=$CName?>" title="Enter your company name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6">
